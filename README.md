# [EFXTV_TUTORIAL_TOPICS. CLICK TO JOIN NOW](https://t.me/errorfix_tv)
Unlocking the World of Ethical Hacking: Top Tools and Topics Revealed! ( Kali Linux, Parrot OS, Windows, Termux, Hacking Tools and Tutorials) [EFXTV](HTTPS://t.me/errorfix_tv)
...
1. Yersinia
1. Oscanner Package
1. Securing communications with Secure Shell
1. Trity
1. Cisco
1. Doona
1. Cisco-torch and Cisco-ocr
1. Trity-tool
1. BBQSQL Blind SQL injection

### Wireless Attacks Tools in Kali Linux Black hat topics
1. Aircrack-ng
1. Hostapd-wpe
1. wirespy
1. Hacking WPS wifi using reaver

### Exploitation Tools in Kali Linux Black hat topics
1. BeEF XSS Exploit
1. Mastering Armitage the graphical management tool for Metasploit
1. msfvenom
1. backdoor-factory
1. Implementing Browser_autopwn
1. SearchSploit
1. Commix Package
1. Payloads
1. sshellnoob4
...
1. Dnsflooding
1. siege Dos Attack 
1. SlowHTTPtest DOS Attack
1. Ping Testing Network Connection
1. T50 Stress Testing Tool
1. Scapy1
1. Scapy2
1. Scapy3
1. DHCPig Stress Testing
1. How To DoS Websites - Slowloris

### Sniffing & Spoofing Tools in Kali Linux Black hat topics
1. Rtpinsertsound-Sniffing-Snoofing
1. laxflood-snaiffing
1. urlsnarf URL sniffer
1. Tcprewrite 
1. Sniffjoke-Sniffing-Spoofing
1. sslstrip 
...
1. Ncrack
1. Creddump tool
1. Polenum Password attack
1. RainbowCrack
1. PACK Password attack tool
1. HashCode Encrypt Passwords 
1. Hydra - Online password attacks

### Maintaining Access Tools in Kali Linux Black hat topics
1. Powersploit
1. RidEnum Maintaining Access
1. Pwnat
...
1. Kali Linux
1. creating phishing page
1. Kali Linux Last Lecturer

### Bonus Lecture:
1. Enumeration
1. Vulnerability Scanning
1. Exploitation and Gaining Access
1. Post-Exploitation - Meterpreter
1. Antivirus Evasion and Cleaning
1. Network Enumeration - Kali 
1. Domain Enumeration - Kali
1. SwisArmy - CrackMapExec - Kali
1. EvilWinRM + Local Privilege Escalation - Kali
1. PowerShell Empire - The Ultimate Tool - Kali
1. Metasploit - Kali
1. Domain Enumeration - RDP
1. Lateral Movement - RDP
1. Domain Privilege Escalation - RDP
1. Domain Persistence and Dominance - RDP
